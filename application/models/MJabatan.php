<?php  
	...
	class MJabatan extends CI_Model
	{
	    ...
	    function getList() {
	    	...
	    	$this->db->select('m_jabatan.id, m_jabatan.name');
	    ...
	    function getColumn() {
	        ...
	        return $this->db->list_fields('m_jabatan');
	    }
	    ...
	    function insert() {
	        ...
	        $this->db->insert('m_jabatan', $a_input);
	    ...
	    function update($id) {
	        ...
	        $this->db->update('m_jabatan', $a_input);
